                ...
                <div class="row">
                    ...
                    <div class="col-3 search-top">
                        ...
                        <form action="#" class="search-top-form">
                            ...
                            <input type="text" id="s" placeholder="¿Qu&eacute; quieres buscar?...">
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="container logo-wrap">
            <div class="row pt-5">
                <div class="col-12 text-center">
                    ...
                    <h1 class="site-logo"><a href="index.html">Consultorio M&eacute;dico</a></h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="owl-carousel owl-theme home-slider">
                        ...
                        <div>
                            <a href="blog-single.html" class="a-block d-flex align-items-center height-lg" style="background-image: url('images/consultorio.jpg'); ">
                                <div class="text half-to-full">
                                    <div class="post-meta">
                                        <span class="category">Lifestyle</span>
                                        <span class="mr-2">March 15, 2018 </span> &bullet;
